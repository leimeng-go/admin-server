...
func (m *defaultMenusModel) Insert(ctx context.Context, data *Menus) (sql.Result, error) {
	...
	ret, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, data.ParentId, data.Path, data.Name, data.Component, data.Title, data.Icon, data.ShowBadge, data.TextBadge, data.IsHide, data.IsHideTab, data.Link, data.IsIframe, data.KeepAlive, data.IsInMainContainer, data.OrderNum, data.DeletedAt)
	}, menusIdKey)
	return ret, err
}
...
func (m *defaultMenusModel) Update(ctx context.Context, data *Menus) error {
	...
	_, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, data.ParentId, data.Path, data.Name, data.Component, data.Title, data.Icon, data.ShowBadge, data.TextBadge, data.IsHide, data.IsHideTab, data.Link, data.IsIframe, data.KeepAlive, data.IsInMainContainer, data.OrderNum, data.DeletedAt, data.Id)
	}, menusIdKey)
	return err
}
